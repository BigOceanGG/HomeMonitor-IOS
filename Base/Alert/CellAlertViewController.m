...
@interface CellAlertViewController ()
...
@implementation CellAlertViewController
...
- (instancetype)initWithTitle:(NSString *)title secondTitle:(NSString *)secondTitle contentView:(void(^)(UIStackView *))configureView cancelTitle:(NSString *)cancelTitle confirmTitle:(NSString *)confirmTitle cancel:(void(^)(void))cancel confirm:(void(^)(void))confirm {
    return [self initWithIconName:@"warning" title:title secondTitle:secondTitle contentView:configureView cancelTitle:cancelTitle confirmTitle:confirmTitle cancel:cancel confirm:confirm];
}
